...
If there's something worth noting (either from transcript or screenshot), respond with JSON:
...
- Only comment if something notable happened
- If nothing worth commenting on, respond with: {"skip": true}
- Don't repeat the same feedback within a session
- Focus on actionable, immediate advice
- When you see a screenshot, comment on visual presentation and content alignment`,
      messages: [
        {
          role: 'user',
